...
<code style="border-radius: 5px; background-color: #3a3a3a; color: white; width: 95%; margin: auto; text-align: center; line-height: 2em;overflow-x: scroll;">
&lt;i class="fa fa-camera-retro fa-lg"&gt;&lt;/i&gt; fa-lg <br>&lt;i class="fa fa-camera-retro fa-2x"&gt;&lt;/i&gt; fa-2x<br>&lt;i class="fa fa-camera-retro fa-3x"&gt;&lt;/i&gt; fa-3x<br>&lt;i class="fa fa-camera-retro fa-4x"&gt;&lt;/i&gt; fa-4x<br>&lt;i class="fa fa-camera-retro fa-5x"&gt;&lt;/i&gt; fa-5x<br></code>
...
<code style="border-radius: 5px; background-color: #3a3a3a; color: white; width: 95%; margin: auto; text-align: center; line-height: 2em;">&lt;div class="list-group"&gt; <br>
...
<div class="inside_container" style="max-height: 260px;">
	<p><code>@keyframes spin {<br>0% {<br>-webkit-transform: rotate(0deg);<br>transform: rotate(0deg);<br>}<br>100% {<br>-webkit-transform: rotate(359deg);<br>transform: rotate(359deg);<br>}<br>}<br></code></p>
...
<div class="inside_container" style="max-height: 410px;">
<p><code>@keyframes vanishIn { <br>0% {<br>opacity: 0;<br>-webkit-transform-origin: 50% 50%;<br>transform-origin: 50% 50%;<br>-webkit-transform: scale(2, 2);<br>transform: scale(2, 2);<br>-webkit-filter: blur(90px);<br>filter: blur(90px);<br>
